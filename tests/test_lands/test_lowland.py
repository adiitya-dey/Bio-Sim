...
def test_create_lowland(reset_params):
    """
    Testing create an Instance of Lowland class object
    ...
    Notes
    ------
    - This creates a Lowland instance
    - asserts fodder is equal to 800
    Returns
    -------
    area.fodder == 800 is True

    """
    area = LowLand()
    assert area.fodder == 800
...
def test_update_params_success(f_max, reset_params):
    ...
    Notes
    ------
    - Sets f_max to 800 with the set_land_params function
    - asserts fodder and f_max are 800
    Returns
    -------
    ...
    """
    LowLand.set_land_params({"f_max": f_max})
    area = LowLand()
...
def test_update_params_dict_fail(reset_params):
    ...
    """
    with pytest.raises(ValueError):
        LowLand.set_land_params({"ff_max": 100})
...
class TestLowLand:
    """
    The test class for the Lowland object
    """

    @pytest.fixture(autouse=True)
    def create(self):
        """
        Create a lowland object for the test class
    ...
    def reset_params(self):
        yield
        LowLand.set_land_params({"f_max": 300})
